    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_funding_button_text', models.CharField(default=b'Fund a new project', help_text=b'The label on the green call to action button at the bottom of the homepage.', max_length=50)),
